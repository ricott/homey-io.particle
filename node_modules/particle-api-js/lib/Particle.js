...
var Particle = function () {
  ...
  */
   ...
   */
		...
		value: function createMeshNetwork(_ref85) {
			var name = _ref85.name,
			    deviceId = _ref85.deviceId,
			    iccid = _ref85.iccid,
			    auth = _ref85.auth,
   ...
   */
		...
		value: function removeMeshNetwork(_ref86) {
			var networkId = _ref86.networkId,
			    auth = _ref86.auth,
   ...
   */
		...
		value: function listMeshNetworks(_ref87) {
			var auth = _ref87.auth,
			    context = _ref87.context,
			    page = _ref87.page,
			    perPage = _ref87.perPage;
   ...
   */
		...
		key: 'getMeshNetwork',
		value: function getMeshNetwork(_ref88) {
   ...
   */
		...
		value: function updateMeshNetwork(_ref89) {
			var networkId = _ref89.networkId,
			    action = _ref89.action,
			    deviceId = _ref89.deviceId,
			    auth = _ref89.auth,
   ...
   */
		...
		value: function addMeshNetworkDevice(_ref90) {
   ...
   */
		...
		value: function removeMeshNetworkDevice(_ref91) {
   ...
   */
		...
		value: function listMeshNetworkDevices(_ref92) {
			var networkId = _ref92.networkId,
			    auth = _ref92.auth,
			    role = _ref92.role,
			    page = _ref92.page,
			    perPage = _ref92.perPage,
   ...
   */
		...
		key: 'deviceUri',
		value: function deviceUri(_ref93) {
			var deviceId = _ref93.deviceId,
			    product = _ref93.product;
