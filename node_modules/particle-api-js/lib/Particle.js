...
var Particle = function () {
  ...
  */
   ...
   */
		...
		value: function setProductConfiguration(_ref96) {
			var auth = _ref96.auth,
			    product = _ref96.product,
			    config = _ref96.config,
   ...
   */
		...
		value: function setProductDeviceConfiguration(_ref97) {
			var auth = _ref97.auth,
			    product = _ref97.product,
			    deviceId = _ref97.deviceId,
			    config = _ref97.config,
   ...
   */
		...
		value: function getProductLocations(_ref98) {
			var auth = _ref98.auth,
			    product = _ref98.product,
			    dateRange = _ref98.dateRange,
			    rectBl = _ref98.rectBl,
			    rectTr = _ref98.rectTr,
			    deviceId = _ref98.deviceId,
			    deviceName = _ref98.deviceName,
			    groups = _ref98.groups,
			    page = _ref98.page,
			    perPage = _ref98.perPage,
   ...
   */
		...
		value: function getProductDeviceLocations(_ref99) {
			var auth = _ref99.auth,
			    product = _ref99.product,
			    dateRange = _ref99.dateRange,
			    rectBl = _ref99.rectBl,
			    rectTr = _ref99.rectTr,
   ...
   */
		...
		key: 'deviceUri',
		value: function deviceUri(_ref100) {
			var deviceId = _ref100.deviceId,
		...
		key: 'delete',
		value: function _delete(_ref105) {
			var uri = _ref105.uri,
			    auth = _ref105.auth,
